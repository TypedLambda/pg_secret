...
CREATE FUNCTION make_secret(key, key, int8) RETURNS secret
  AS '/Users/daniel/Projects/Modulo/spikes/ore_types/pgsecret', 'make_secret'
  LANGUAGE C IMMUTABLE STRICT;

CREATE FUNCTION make_secret(key, key, text) RETURNS secret
  AS '/Users/daniel/Projects/Modulo/spikes/ore_types/pgsecret', 'make_secret_string'
  LANGUAGE C IMMUTABLE STRICT;

CREATE FUNCTION secret_lt(secret, secret) RETURNS bool
  AS '/Users/daniel/Projects/Modulo/spikes/ore_types/pgsecret'
  LANGUAGE C IMMUTABLE STRICT;
